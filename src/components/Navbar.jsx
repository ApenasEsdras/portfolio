  ...
  return (
    <nav className='navbar'>
        <HashLink smooth to='#portfolio'>
          <h1 data-last-letter="."><span>E</span>SDRAS</h1>
        </HashLink>
        <ul className="nav-list">
            ...
            <li><a target='_blank' rel='noreferrer' href="https://www.linkedin.com/in/esdrasdeoliveira/" id='btn-ctt'>Contato</a></li>
        </ul>
        ...
        <div className="navbar-responsive">
          ...
          <li><HashLink smooth to='/#section-about'>Sobre</HashLink></li>
            ...
            <li><a href="https://www.linkedin.com/in/esdrasdeoliveira/" id='btn-ctt'>Contato</a></li>
          </ul>
